...
export function downloadMP4(info: ytdl.videoInfo, path_to_save: string): Promise<{ success: true, location: string }> {
...
export function downloadMP3(info: ytdl.videoInfo, path_to_save: string): Promise<{ success: true, location: string }> {
