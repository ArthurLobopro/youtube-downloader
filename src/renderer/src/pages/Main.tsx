...
import { Modal, ModalBody, ModalFooter, ModalHeader, ModalWrapper, OkButton } from "@renderer/components/Modals/base"
    ...
    return (
        <div className="flex flex-col gap-1 w-full justify-center items-center">
            ...
            <div className="flex items-center w-4/5">
                ...
                />
                <button type="button" className="w-10 bg-blue-500 grid place-content-center h-full rounded-e" onClick={search}>
